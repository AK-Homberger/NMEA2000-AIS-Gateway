...
It was necessary to change the code to make it usable with the Arduino IDE and the ESP32. The reason for the changes was the different versions of C-Compiler versions (clang#14 to clang#11). It was quite an effort to do the backport to Arduino clang#11 version, because of missing functions.
